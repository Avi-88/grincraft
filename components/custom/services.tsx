...
<section className="bg-[#262626] w-full">
  ...
  <main
    className="flex md:flex-row justify-center flex-col gap-[100px] md:gap-[40px] lg:gap-[100px] mx-auto w-full max-w-[1440px] min-w-[280px]  py-8 px-4 lg:px-8"
  >
    <div id="services"  className="flex flex-col justify-center text-center items-center  mt-16">
      <p className="text-xl text-[#3d8b80]">Expert care for a healthy, confident smile—routine checkups, cosmetic enhancements, and advanced treatments, all in one place.</p>
      <h2 
        className="text-[30px] leading-[48px] md:text-[50px] md:leading-[68px] mt-5 mb-16 text-white"
      >Your smile is in great hands!</h2>
      <button
        className="w-full flex items-center justify-between outline-gray-600 max-w-[300px] text-xl  font-bold sm:text-lg  rounded-[38px] bg-[#fff] text-[##262626] py-2 md:py-4 px-6 sm:px-9"
    ...
    <div
      className="flex md:mt-[-70px] items-center flex-col md:grid md:grid-cols-[220px_220px] lg:grid-cols-[250px_250px] grid-rows-8 gap-[60px] md:gap-[30px] lg:gap-[45px]"
    >
      <div
        className="col-start-1 col-end-2 row-start-1 row-end-4   bg-[#ffffff]  rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px]   p-8 md:p-4 lg:p-8"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="50px"
        ...
        <div>
          <span
            className="text-[72px] text-black leading-[93px]  font-bold"
          >1<span className="text-[#3d8b80]">.</span></span>
          <p>
            <span className="text-2xl font-bold">General</span><br
            /><span className="text-xl font-semibold ">Diagnostics care</span><br /><span
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
      ...
      <div
        className="col-start-2 col-end-3 row-start-2 row-end-5   bg-[#3d8b80]  rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px]   p-8 md:p-4 lg:p-8"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="50px"
        ...
        <div><span
            className="text-[72px] text-black leading-[93px]  font-bold"
          >2<span className="text-[#fff]">.</span></span>
          <p>
            <span className="text-2xl font-bold">Cosmetic</span><br
            /><span className="text-xl font-semibold ">Dentistry</span><br /><span
              className="text-md font-extralight"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
      ...
      <div
        className="col-start-1 col-end-2 row-start-4 row-end-7   bg-[#3d8b80]  rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px]   p-8 md:p-4 lg:p-8"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="50px"
        ...
        <div><span
            className="text-[72px] text-black leading-[93px]  font-bold"
          >3<span className="text-[#fff]">.</span></span>
          <p>
            <span className="text-2xl font-bold">Restorative</span><br
            /><span className="text-xl font-semibold ">Dentistry</span><br /><span
              className="text-md font-extralight"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
      ...
      <div
        className="col-start-2 col-end-3 row-start-5 row-end-8   bg-[#fff]  rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px]   p-8 md:p-4 lg:p-8"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="50px"
        ...
        <div>
          <span
            className="text-[72px] text-black leading-[93px]  font-bold"
          >4<span className="text-[#3d8b80]">.</span></span>
          <p>
            <span className="text-2xl font-bold">Surgical</span><br
            /><span className="text-xl font-semibold ">Dentistry</span><br /><span
              className="text-md font-extralight"
...
//       <h2 className="text-[#3d8b80] text-xl font-bold">{title}</h2>
//       <p className="text-[#5fa398] mt-2">{description}</p>
//       <button className="mt-4 px-4 py-2 bg-[#3d8b80] text-white rounded-lg hover:bg-[#2f6f65]">
//         Learn More
//       </button>
//     </div>
//   );
